...
/* Make sure to check the analog pin number availble for your corresponding MCU*/
#define S0 18
#define S1 19
#define S2 20
#define S3 21
...
// Make sure to check the PWM capability of the pins of your corresponding MCU
#define RF 10    //right forward
#define RB 11    //right backward
#define LF 12     //left backward
#define LB 13     //left forward
#define LPWM  14 // Left PWM pin
#define RPWM  15 // Right PWM pin
